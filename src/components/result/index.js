    ...
    return (
      <ListItem style={style} key={index} component="div" disablePadding>
        ...
        <Stack direction="column" spacing={1}>
          ...
          <Button onClick={()=>dispatch(putFavoriteCities(countries[index]))}  variant="contained">i want to visit</Button>
        </Stack>
      </ListItem>
    );
  }
  ...
  return(
    <>
      <Grid mt={1} container spacing={2}>
        <Grid item xs={8}>
              <Box
              sx={{ width: '100%', height: 800, maxWidth:800, bgcolor: 'background.paper' }}
              >
              <FixedSizeList
              height={800}
              width={800}
